...
from .views import (GammeControleCreateView, GammeControleDetailView, GammeControleListView, GammeControleUpdateView, GammeControleDeleteView, view_gamme_pdf, 
                    ...
                    demo_select_view, demo_login_view, demo_switch_view)
app_name = 'Gamme'
urlpatterns = [
    path('', RedirectView.as_view(pattern_name='Gamme:demo_select', permanent=False)),

    # Demo mode routes (portfolio)
    path('gamme/demo/', demo_select_view, name='demo_select'),
    path('gamme/demo/login/<str:role>/', demo_login_view, name='demo_login'),
    path('gamme/demo/switch/', demo_switch_view, name='demo_switch'),
